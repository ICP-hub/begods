...
var minterSeed = "wire clever winner still panel echo fever photo core shoe theory swear fun time embody field marble toilet method mimic endless economy festival local";

var canisterIdIC = "rrkah-fqaaa-aaaaa-aaaaq-cai";
var canisterIdLocal = "rrkah-fqaaa-aaaaa-aaaaq-cai";

var basePath = "/home/wantedbear/Desktop/ext-v2-token/"
...
const Secp256k1KeyIdentity = require('@dfinity/identity-secp256k1').Secp256k1KeyIdentity;
...
(async () => {
  ...
  // mint in the end
  const data = await API.ext_mint(toMint);
