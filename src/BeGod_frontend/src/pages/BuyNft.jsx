   ...
   // console.log("card index",index);
    ...
    const fetchCardDetails=async()=>{
       ...
       // console.log("buying nft details 0 2" , result[0][2].nonfungible.metadata[0]);
        ...
        console.log(cardDetails,'metadata')
                    ...
                    <div className='hidden w-full sm:flex' >
                        ...
                        <div>
                                ...
                                >
                                        ...
                                        <SkeletonTheme baseColor="#202020" highlightColor="#444">                                       
                                            <Skeleton count={1} height={320} width={250}   className='object-cover border-none rounded-lg shadow-lg'/>
                                        </SkeletonTheme>
                                    </div>
                                    ...
                                    <div className='flex flex-col items-center justify-center mt-5 '>
                                        ...
                                        <h1 className='flex items-center mt-2 text-base font-extralight'>
                                            ...
                                            <CopyToClipboard text='828746888'> 
                                                <span className='ml-2 cursor-pointer text-slate-300'><RiFileCopyLine /></span>
                                            </CopyToClipboard>
