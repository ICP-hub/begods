...
import image from "./40.png"; // Adjust the path according to your project structure

const UnauthorizedPage = () => {
  return (
    <div className="bg-gradient-to-b from-gray-600 to-black-800 text-white h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="text-center">
        ...
        {/* Description */}
        <p className="mt-4 mb-6 text-md sm:text-lg md:text-xl max-w-md mx-auto  text-gray-300">
