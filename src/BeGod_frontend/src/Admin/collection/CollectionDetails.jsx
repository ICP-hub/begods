  ...
  return (
    <div className='w-[90%] overflow-y-scroll pt-10 px-10 pb-8 h-screen no-scrollbar  no-scroll 2xl:ml-[7%] md:w-full lg:w-[90%] lg:pt-20'>
      <div className='w-full'>
        ...
        <div className='flex flex-col md:flex-row gap-x-8 items-center bg-[#414141] w-full  p-10 text-[#FFFFFF] justify-center rounded-md my-10'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-sm font-normal font-Quicksand md:text-xl'>{detail}</p>
            <h3 className='text-sm font-bold font-Quicksand md:text-xl'>Collection ID - {collectionId}</h3>
          </div>
        </div>
        ...
        <div className='w-full pb-12 text-white'>
          ...
          <div className='flex flex-row justify-center gap-5 mt-8 overflow-x-auto overflow-y-hidden sm:flex-wrap md:gap-8 xl:gap-5'>
