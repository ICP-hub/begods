...
const UserDetails = () => {
    ...
    return (
        <div className='text-white mt-[20%] md:mt-0'>
            ...
            <div className='w-[90%] md:w-[948px] h-auto md:h-[370px] bg-[#29292C] mt-[15%] md:mt-[5%] md:ml-[10%] flex flex-col md:flex-row'>
                <div className='h-1/2 md:h-full md:w-1/2 flex items-center justify-center'>
                    <div className='w-[30%] w-[30%] flex items-center justify-center'>
                        <img src={filteredNft.img} alt="" className='ml-[13%] md:ml-[20%] mt-[10%] w-full h-full rounded-full object-cover' />
                    </div>
                </div>
                <div className='h-1/2 md:h-full md:w-1/2 flex flex-col gap-[10px] pl-[5%] md:justify-center '>
