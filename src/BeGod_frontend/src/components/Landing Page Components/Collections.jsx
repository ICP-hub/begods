...
const Collections = () => {
  return (
    <div className='w-[80%] ml-[10%] mt-36'>
      ...
      <div className='flex flex-row justify-center gap-8 items-center mt-8'>
        {/* Norse Collection */}
        <div className='relative w-[18%] h-[8vh] bg-[#4A4A4A] flex items-center justify-center gap-4 transition-all duration-500 ease-in-out shadow-lg hover:shadow-xl hover:-translate-y-2 hover:bg-gradient-to-r hover:from-[#4A4A4A] hover:via-[#6272a4] hover:to-[#282a36] border-2 border-transparent hover:border-transparent hover:bg-transparent'>
