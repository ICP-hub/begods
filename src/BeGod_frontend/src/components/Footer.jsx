...
const Footer = () => {
    return (
        <div style={{ fontFamily: "QuickSand" }} className="w-full h-auto sm:h-[287px] text-[#FFFFFF]">
            <h1 className="ml-[10%] sm:ml-[20%] pt-[5%] text-lg sm:text-xl">Logo</h1>
            <div className="flex flex-col sm:flex-row ml-[10%] sm:ml-[20%] mt-4">
                <p className="w-[90%] sm:w-[25%] text-sm sm:text-base">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-24 mt-4 sm:mt-0 sm:ml-[10%]">
                    <div className="flex flex-col gap-2 sm:gap-4">
                        <div className='flex gap-8'>
                            <h1 className="text-lg sm:text-xl">Home</h1>
                            <h1 className="flex sm:hidden text-lg sm:text-xl">Collection</h1>
                        </div>
                        <Link to="#" className="flex items-center justify-start sm:justify-center gap-2 h-[8%]">
                    ...
                    <div className="flex flex-col gap-2 sm:gap-4">
                        ...
                        <Link to="#" className="flex items-center justify-start sm:justify-center gap-2 h-[8%] pr-4">
