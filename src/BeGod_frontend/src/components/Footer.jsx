...
const Footer = () => {
    return (
        <div style={{ fontFamily: "QuickSand" }} className="w-full h-auto sm:h-[287px] text-[#FFFFFF]">
            ...
            <div className="flex flex-col md:flex-row ml-[10%] sm:ml-[20%] mt-4">
                <p className="w-[90%] md:w-[25%] text-sm sm:text-base">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-24 mt-4 sm:mt-0  md:ml-[10%]">
                    <div className="flex flex-col gap-2 sm:gap-4">
                        ...
                        <Link to="#" className="flex items-center justify-start sm:justify-center gap-2 h-[8%] sm:-ml-[10vw] md:ml-0">
                    ...
                    <div className="flex flex-col gap-2 sm:gap-4">
                        ...
                        <Link to="#" className="flex items-center justify-start sm:justify-center gap-2 h-[8%] pr-4  sm:-ml-[10vw] md:ml-0">
