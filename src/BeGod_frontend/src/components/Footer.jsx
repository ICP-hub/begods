...
const Footer = () => {
    return (
        <div style={{ fontFamily: "QuickSand" }} className="max-w-[1920px] mx-auto w-full h-[400px] sm:h-[350px] md:h-[350px] text-[#FFFFFF]">
            <div className='h-[10vh]  sm:ml-[17%]'>
                <img src="/Hero/logo.png" alt="" />
            </div>
            <div className="flex flex-col lg:flex-row ml-[10%] sm:ml-[20%] mt-8">
                <p className="w-[90%] lg:w-[35%] xl:w-[25%] text-sm sm:text-base">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-24 mt-4 sm:mt-4  md:ml-[4%]">
