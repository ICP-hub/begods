...
dfx canister call icrc2_token_canister icrc1_transfer "(record { to = record { owner = principal \"sfczs-5f2rv-6x62i-t3ca4-xxetq-h53h3-nrsaf-pjdgy-o7nid-csao7-uqe\";}; amount = 500000000;})"
